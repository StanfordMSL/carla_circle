...
If the query is for ego car, then the next waypoints are always in the circle,
otherwise, it picks the route that the ego vehicle is on 
"""
import math
import threading
import rospy
